...
<template>
  <section :style="{ background: 'var(--hero-wash)' }">
    <div
      class="mx-auto grid gap-12 lg:grid-cols-[1.05fr_.95fr] items-start"
      style="max-width: 1060px; padding: 26px 22px 68px"
    >
      <div>
        ...
        <p
          ...
          style="font-size: 17.5px; line-height: 1.65; margin: 20px 0 28px; max-width: 32em"
        >
        ...
        <div class="flex flex-wrap gap-3">
          ...
          <AppButton :to="waHref" variant="outline" size="lg" pill>
            WhatsApp kami
          </AppButton>
        </div>
