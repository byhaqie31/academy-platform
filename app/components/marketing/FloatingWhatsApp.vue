...
<template>
  <a
    ...
    target="_blank"
    rel="noopener"
    :aria-label="`WhatsApp ${academy.name}`"
    class="fixed z-40 grid place-items-center text-white sm:hidden transition-transform duration-150 hover:-translate-y-0.5 active:translate-y-0"
    :style="{
      right: '18px',
