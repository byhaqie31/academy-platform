    ...
    <div class="flex flex-col" style="gap: 12px">
      <div v-for="(h, i) in weeks" :key="i">
        <div class="flex items-center justify-between" style="margin-bottom: 6px">
          <span class="text-ink" style="font-size: 12.5px; font-weight: 700">Minggu {{ i + 1 }}</span>
      ...
      >
        <span class="text-ink" style="font-weight: 800; font-size: 13.5px">Jumlah jam</span>
