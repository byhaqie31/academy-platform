...
//
// ILLUSTRATIVE, not confirmed by Hz: the price and the seat counts.
export const campaign: LandingCampaign = {
  slug: 'rendah-matematik-august',
  level: 'rendah',
  subject: 'matematik',
  campaign: 'august',

  pills: ['Ambilan Ogos 2026', 'Tahun 4, 5 dan 6', '100% online'],
  ...
  proof: {
    ...
    testimonials: ['aisyah-rendah', 'rizal-rendah', 'meiling-rendah'],
  },
