...
export const campaign: LandingCampaign = {
  slug: 'ma-matematik-ogos',
  level: 'ma',                       // 'rendah' | 'mr' | 'ma'
  subject: 'matematik',
  campaign: 'ogos',

  pills: ['Ambilan Ogos 2026', 'Tingkatan 4 & 5', '100% online'],
  ...
  proof: { stats: ['since2014', 'students', 'classSize'], testimonials: ['aisyah', 'rizal', 'meiling'] },
